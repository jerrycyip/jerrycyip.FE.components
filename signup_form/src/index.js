...
(() => {
  ...
  async function submitFn(event){
    ...
    $passwordConfirmInput.removeAttribute('aria-invalid'); // remove aria invalid attribute
    $passwordMismatchError.classList.add('hidden'); // hide error message
    ...
    // Only fields can't leverage browser to validate is pw confirmation, hence use JS
